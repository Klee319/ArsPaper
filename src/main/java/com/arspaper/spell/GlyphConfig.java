...
public class GlyphConfig {
    ...
    private static final Map<String, Set<String>> AUGMENT_COMPAT = Map.ofEntries(
        ...
        Map.entry("harm",            Set.of("amplify", "dampen", "aoe_radius", "extend_time", "duration_down")),
        Map.entry("ignite",          Set.of("amplify", "dampen", "aoe_radius", "extend_time", "duration_down")),
        Map.entry("freeze",          Set.of("amplify", "dampen", "aoe_radius", "extend_time", "duration_down")),
        ...
        Map.entry("snare",           Set.of("amplify", "dampen", "aoe_radius", "extend_time", "duration_down")),
        ...
        Map.entry("bubble",          Set.of("amplify", "dampen", "aoe_radius", "extend_time", "duration_down")),
        Map.entry("prestidigitation", Set.of("randomize")),
        // === Effects - Tier 2 ===
        Map.entry("heal",            Set.of("amplify", "dampen", "aoe_radius")),
        Map.entry("grow",            Set.of("amplify", "dampen", "aoe_radius")),
        Map.entry("explosion",       Set.of("amplify", "dampen", "aoe_radius", "extract")),
        Map.entry("exchange",        Set.of("amplify", "dampen", "aoe_radius")),
        Map.entry("smelt",           Set.of("aoe_radius")),
        Map.entry("crush",           Set.of("amplify", "dampen", "aoe_radius", "fortune")),
        ...
        Map.entry("speed_boost",     Set.of("amplify", "dampen", "aoe_radius", "extend_time", "duration_down", "randomize")),
        Map.entry("levitate",        Set.of("amplify", "dampen", "aoe_radius", "extend_time", "duration_down")),
        // === Effects - Tier 3 ===
        Map.entry("blink",           Set.of("amplify", "dampen")),
        Map.entry("lightning",       Set.of("amplify", "dampen", "aoe_radius", "extend_time", "duration_down")),
        Map.entry("wither",          Set.of("amplify", "dampen", "aoe_radius", "extend_time", "duration_down")),
        Map.entry("hex",             Set.of("amplify", "dampen", "aoe_radius", "extend_time", "duration_down")),
        ...
        Map.entry("intangible",      Set.of("amplify", "dampen", "aoe_radius", "extend_time", "duration_down")),
